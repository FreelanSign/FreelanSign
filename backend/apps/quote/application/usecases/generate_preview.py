...
from apps.quote.application.dto.quote_viewmodels import QuoteViewModel, LineVM, TotalsVM
...
def generate_preview(dto: PreviewPayloadDto) -> QuoteViewModel:
    ...
    for line in dto.lines:
        rate_pct = effective_rate_for_line(
            line.tax_rate_pct,
            owner_vat_exempt=dto.owner.vat_exempt,
            owner_default_tax_rate=dto.owner.default_tax_rate,
        )
